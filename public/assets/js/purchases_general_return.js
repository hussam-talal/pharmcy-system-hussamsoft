$(document).ready(function () {
  ...
  $(document).on('change', '#items_batches_autoserial', function (e) {
    var items_batches_autoserial = $(this).val();
    if (items_batches_autoserial != "") {
      var Batchunitprice = $("#items_batches_autoserial option:selected").data("price");
  ...
  $(document).on('mouseenter', '#AddItemToIvoiceDetailsActive', function (e) {
    if ($("#items_batches_autoserial").length) {
      var batchSerial = $("#items_batches_autoserial").val();
  ...
  $(document).on('click', '#AddItemToIvoiceDetailsActive', function (e) {
    ...
    if (unit_id == "") {
      alert("من فضلك اختر  وحدة المرتجع ");
      $("#unit_id").focus();
      return false;
    }
    var items_batches_autoserial = $("#items_batches_autoserial").val();
    if (items_batches_autoserial == "") {
      alert("من فضلك اختر  الباتش ");
      $("#items_batches_autoserial").focus();
      return false;
    }
    ...
    var BatchQuantity = $("#items_batches_autoserial option:selected").data("qunatity");
    ...
    jQuery.ajax({
      ...
      data: {
        ...
        item_code: item_code,
        unit_id: unit_id, items_batches_autoserial: items_batches_autoserial,
        item_quantity: item_quantity,
        item_price: item_price,
        item_total: item_total,
        ismainunit: ismainunit,
        autoserail: autoserail
      },
      success: function (data) {
     alert("تمت الاضافة");
     get_inv_itemcard_batches(items_batches_autoserial);
     //reload_parent_pill();
     reload_itemsdetials();
      ...
      jQuery.ajax({
        ...
        success: function (data) {
          ...
          if (oldBatchId != null) {
            ...
            $("#items_batches_autoserial").val(oldBatchId);
  ...
  function reload_itemsdetials() {
    ...
    jQuery.ajax({
      ...
      dataType: 'html',
      cache: false,
      data: { autoserail: autoserail, "_token": token_search },
      success: function (data) {
  ...
  $(document).on('click', '.load_edit_item_details', function (e) {
    ...
    jQuery.ajax({
      ...
      dataType: 'html',
      cache: false,
      data: { autoserail: autoserail, "_token": token_search, id: id },
      success: function (data) {
  ...
  $(document).on('click', '#load_modal_add_detailsBtn', function (e) {
    ...
    var suuplier_code=$("#suuplier_code").val();
    var store_id=$("#store_id").val();
    if (order_date == "") {
      alert(" لازم ادخال التاريخ ");
      $("#order_date").focus();
      return false;
    }
    if (suuplier_code == "") {
      alert(" لازم تحدد المورد ");
      $("#suuplier_code").focus();
      return false;
    }
    if (store_id == "") {
      alert("لازم تحديد مخزن المرتجع ");
      $("#store_id").focus();
      return false;
    }
    var autoserail = $("#autoserail").val();
    ...
    jQuery.ajax({
      ...
      dataType: 'html',
      cache: false,
      data: { autoserail:autoserail, "_token": token_search, id: id, order_date:order_date,suuplier_code:suuplier_code,
      store_id:store_id},
      success: function (data) {
  ...
  $(document).on('click', '#EditDetailsItem', function (e) {
    ...
    jQuery.ajax({
      ...
      cache: false,
      data: {
        autoserail: autoserail, "_token": token_search, item_code_add: item_code_add, unit_id_Add: unit_id_Add, ismainunit: ismainunit,
  ...
  function recalcualte() {
    ...
    var total_befor_discount = total_cost_items 
  ...
  $(document).on('mouseenter', '#do_close_approve_invoice_now', function (e) {
    var token_search = $("#token_search").val();
    var ajax_search_url = $("#ajax_load_TreasuryDiv").val();
