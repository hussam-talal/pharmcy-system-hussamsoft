...
@section('content')
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title card_title_center">بيانات الدليل المحاسبي ( الحسابات المالية )      </h3>
          ...
          <a href="{{route('accountTypes.index')}}" class="btn btn-sm  btn-primary">أنواع الحسابات المالية</a>  
        </div>
        ...
        <div id="ajax_responce_serarchDiv" class="col-md-12">
         ...
         @foreach ($data as $info )
            <tr>
             ...
             <td>@if($info->is_main==1) نعم  @else  لا @endif</td>  
