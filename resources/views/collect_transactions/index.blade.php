...
@section('content')
        ...
        <div class="col-md-3"> 
          <div class="form-group"> 
            ...
            <select name="treasuries_id" id="treasuries_id" class="form-control ">
              ...
              <option value="{{ $checkExiststreasuries['treasuries_id'] }}"> {{ $checkExiststreasuries['treasuries_name'] }} </option>
            ...
            <div class="col-md-3 "> 
              <div class="form-group">
                ...
                <input  readonly name="treasuries_balance" id="treasuries_balance" class="form-control"  value="{{ $checkExiststreasuries['balance']*1 }}"  >
          ...
          <div class="form-group">
            ...
            @enderror
              ...
              <div class="col-md-6">   
                <div class="form-group">
                  <label>   البيان</label>
              <textarea name="byan" id="byan" class="form-control" rows="3" cols="10"> {{ old("byan","تحصيل نظير ") }} </textarea>
                  @error('byan')
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
    ...
    تنبيه لايوجد خزنة متاحة لك لكي تتمكن من التحصيل
      </div>    
      @endif
 ...
 <div class="row" style="padding: 15px;">
  ...
  <div class="col-md-3">
    ...
    <input style="margin-top: 6px !important;" type="text" id="search_by_text" placeholder="" class="form-control"> <br>
              ...
              <div class="col-md-3"> 
                <div class="form-group"> 
                  <label>  بحث  باسم الحساب المالي</label>
        ...
        <div id="ajax_responce_serarchDiv">
         ...
         <td>
        <a href="{{ route('treasuries.edit',$info->id) }}" class="btn btn-dm  btn-primary">طباعة</a>   
         </td>
           </tr> 
         @endforeach
        </tbody>
...
<script  src="{{ asset('assets/js/collect_transaction.js') }}"> </script>
