        ...
        <div class="col-md-3"> 
          <div class="form-group"> 
            ...
            <div class="col-md-3" > 
              <div class="form-group">
                ...
                <input  readonly name="treasuries_balance id="treasuries_balance class="form-control"  value="{{ $checkExiststreasuries['treasuries_balance_now']*1 }}"  >
          ...
          <div class="form-group">
            ...
            <div class="col-md-6">   
                <div class="form-group">
                  <label>   البيان</label>
              <textarea name="byan" id="byan" class="form-control" rows="3" cols="10"> {{ old("byan","صرف نظير ") }} </textarea>
                  @error('byan')
                  <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
          ...
          <div class="form-group text-center">
            <button id="do_exchange_now_btn" type="submit" class="btn btn-success btn-sm"> صرف الان</button>
                ...
                <div class="alert alert-warning" style="color:rgb(128, 7, 7) !important">
              تنبيه لايوجد خزنة متاحة لك لكي تتمكن من 
                </div>    
                @endif
...
<script  src="{{ asset('assets/js/exchange_transaction.js') }}"> </script>
