...
<div class="form-group"> 
    ...
    <option @if($item_card_Data['unit_id']==$item_data_detials['unit_id']) selected @endif data-ismainunit="1"   value="{{ $item_card_Data['unit_id'] }}"> {{ $item_card_Data['parent_unit_name']  }} (وحده رئيسة) </option>
    <option  @if($item_card_Data['retail_units_id']==$item_data_detials['unit_id']) selected @endif data-ismainunit="0"   value="{{ $item_card_Data['retail_units_id'] }}"> {{ $item_card_Data['retial_unit_name']  }} (وحدة تجزئة) </option>
