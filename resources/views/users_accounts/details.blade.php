...
<a href="#" class="btn btn-sm btn-success">تعديل</a>
     ...
     <div class="card-header">
        <h3 class="card-title card_title_center"> الخزن المضافة لصلاحيات المستخدم
            ...
            <button href="#" class="btn btn-md btn-primary" data-toggle="modal" data-target="#Add_treasuries_modal">اضافة جديد</button>
     ...
     <div id="ajax_responce_serarchDiv">
        ...
        @if (@isset($users_treasuries) && !@empty($users_treasuries))
        @php
         $i=1;   
        @endphp
        <table id="example2" class="table table-bordered table-hover">
       ...
       <td>
  <a href="{{ route('users_accounts.delete_treasuries_delivery',$info->id) }}" class="btn btn-sm btn-danger are_you_shue">حذف</a>
       </td>
  ...
  <div class="modal-dialog modal-xl" >
    <div class="modal-content bg-info">
      ...
      <div class="modal-body" id="Add_treasuries_modal_body" style="background-color: white !important; color:black;">
        ...
        <form action="{{ route('users_accounts.Add_treasuries_To_User',$data['id']) }}" method="post" >
          @csrf
