...
return view('suppliers.create', ['suppliers_categories' => $suppliers_categories]);
}
...
$suppliers_categories = get_cols_where(new SupplierCategories(), array('id', 'name'), array('com_code' => $com_code, 'active' => 1), 'id', 'DESC');
return view('suppliers.edit', ['data' => $data, 'suppliers_categories' => $suppliers_categories]);
}
...
return view('suppliers.ajax_search', ['data' => $data,'mirror'=>$mirror]);
}
}
}