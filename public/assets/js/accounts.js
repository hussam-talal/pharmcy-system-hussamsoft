$(document).ready(function(){
  $(document).on('change','#is_main',function(e){
...
$(document).on('change','#start_balance_status',function(e){
  ...
  $(document).on('input','#is_main_search',function(e){
    make_search();
  });
  ...
  function make_search(){
    ...
    var is_main=$("#is_main_search").val();
    ...
    jQuery.ajax({
      ...
      searchbyradio:searchbyradio,account_type:account_type,is_main:is_main,active_search:active_search},
  ...
  $(document).on('click','#ajax_pagination_in_search a ',function(e){
    ...
    jQuery.ajax({
      ...
      dataType:'html',
      cache:false,
      data:{search_by_text:search_by_text,"_token":token_search,searchbyradio:searchbyradio,account_type:account_type,is_main:is_main,active_search:active_search},
      success:function(data){
