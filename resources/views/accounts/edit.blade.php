...
<div class="col-md-6"> 
  ...
  <div class="col-md-6">
    <div class="form-group"> 
      ...
      <option   {{  old('account_types',$data['is_main'])==1 ? 'selected' : ''}} value="1"> نعم</option>
       <option {{  old('account_types',$data['is_main'])==0  ? 'selected' : ''}} value="0"> لا</option>
      </select>
      @error('is_main')
      <span class="text-danger">{{ $message }}</span>
      @enderror
    ...
    <div class="col-md-6" id="parentDiv"   @if(old('is_main',$data['is_main'])==1 ) style="display: none;" @endif   > 
      <div class="form-group"> 
