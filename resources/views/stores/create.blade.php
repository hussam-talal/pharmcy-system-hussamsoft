...
<div class="form-group">
  ...
  <input name="phones" id="phones" class="form-control" value="{{ old('phones') }}" placeholder="ادخل اسم  المخزن" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')" onchange="try{setCustomValidity('')}catch(e){}"  >
  @error('phones')
  <span class="text-danger">{{ $message }}</span>
  @enderror
</div>
...
<div class="col-3">
  <div class="form-group">
    ...
    <input name="address" id="address" class="form-control" value="{{ old('address') }}" placeholder="ادخل اسم  المخزن" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')" onchange="try{setCustomValidity('')}catch(e){}"  >
    @error('address')
    <span class="text-danger">{{ $message }}</span>
    @enderror
  </div>
