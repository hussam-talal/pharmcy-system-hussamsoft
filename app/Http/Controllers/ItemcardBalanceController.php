...
$allitemscardData=get_cols_where_p(new items(),array("id","name","item_code","item_type","does_has_retailunit","retail_uom_id","uom_id","retail_uom_quntToParent","All_QUENTITY"),array("com_code"=>$com_code),"id","ASC",PAGINATION_COUNT);
...
return view('itemcardBalance.index',['allitemscardData'=>$allitemscardData,'inv_itemcard_categories'=>$inv_itemcard_categories,'itemCardsSearch'=>$itemCardsSearch,'storesSearch'=>$storesSearch]);
}
