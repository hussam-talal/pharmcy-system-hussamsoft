...
<form action="{{ route("purchasesreturn.do_approve",$data['auto_serial']) }}" method="post">
     @csrf
...
عفوا لايمكن ترحيل الفاتورة قبل  اضافة الأصناف عليها !!!
</div>
      @endif
...
@else
<div class="alert alert-danger">
عفوا لقد تم ترحيل هذه الفاتورة من قبل !!!
</div>
      @endif
