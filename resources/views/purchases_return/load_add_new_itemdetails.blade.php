  <div class="row">
   ...
   <div class="col-md-3  " style="display: none;" id="UomDiv">
    ...
    <div class="col-md-3 relatied_to_itemCard" style="display: none;">
      <div class="form-group">
   ...
   <div class="col-md-2">
    ...
    <button type="button" style="margin-top: 31px;" class="btn btn-md btn-danger" id="AddItemToIvoiceDetailsActive">اضف للفاتورة</button>
  </div>
   </div>
