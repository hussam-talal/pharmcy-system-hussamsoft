...
$checkExiststreasuries['treasuries_balance_now'] = get_sum_where(new Treasuries_transactions(), "money", array("com_code" => $com_code, "treasuries_id" => $checkExiststreasuries['treasuries_id']));
}
$mov_type = get_cols_where(new Mov_type(), array("id", "name"), array("active" => 1, 'in_screen' => 1, 'is_private_internal' => 0), 'id', 'ASC');
$accounts = get_cols_where(new Account(), array("name", "account_number", "account_type"), array("com_code" => $com_code, "active" => 1), 'id', 'DESC');
if (!empty($accounts)) {
...
return view('exchange_transaction.index', ['data' => $data, 'checkExiststreasuries' => $checkExiststreasuries, 'accounts' => $accounts, 'mov_type' => $mov_type, 'treasuries' => $treasuries, 'admins' => $admins, 'accounts_search' => $accounts_search]);
}
...
return view('exchange_transaction.ajax_search', ['data' => $data, 'totalExchangeInSearch' => $totalExchangeInSearch]);
}
}
}